...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 10-04-2023 a las 05:07:45
...
(4, 'Instituto Tecnológico De Zacatecoluca', '1', b'1', 1),
(5, 'Instituto Nacional José Siméon Cañas', '2', b'1', 1),
(6, 'Instituto Tecnológico en Computación e Idiomas', '1', b'0', 2),
(7, 'Instituto Nacional “Doctor Sarbelio Navarrete”', '1', b'1', 2),
(8, '\r\nInstituto Nacional \"Walter Thilo Deininger\"', '2', b'1', 4),
(9, 'Instituto Nacional Suchitoto', '1', b'0', 4),
(10, 'Instituto Tecnológico de Formación Profesional', '1', b'0', 7),
(11, 'Instituto Nacional de Victoria', '2', b'0', 7);
...
INSERT INTO `registro` (`id_registro`, `nombre_registro`, `apellido_registro`, `nie`, `fecha_nacimiento`, `genero`, `foto`, `correo`, `fecha_registro`, `estado_registro`, `id_usuario`, `id_grado`, `id_municipio`, `id_Roll`) VALUES
(2, 'Lili Patricia ', 'Lopez Lopez', 12365478, '2001-06-23', 'Femenino', 'http://localhost/phpmyadmin/index.php?route=/table/change&db=sistema&table=registro', 'progra.lili2023@gmail.com', '2023-03-29', b'0', 1, 1, 1, 0),
(3, 'Luis Oswaldo', 'Zaldana', 12395764, '2000-06-23', 'Masculino', 'http://localhost/phpmyadmin/index.php?route=/table/change&db=sistema&table=registro', 'lliajab12@gmail.com', '2023-03-28', b'0', 2, 5, 2, 0),
(5, 'Ana Patricia', 'Zaldaña', NULL, '1999-05-11', 'Femenino', 'http://localhost/phpmyadmin/index.php?route=/table/change&fgdfgdfgdfddfdb=sistema&table=registro', 'corereo@gmail.com', '2023-03-07', b'0', 3, NULL, 6, 0),
(6, 'Gabriella Teresa', 'Nunez Maduro', 37062285, '2006-05-05', 'Femenino', 'http://account.example.com/angle/badge', 'bihokeb171@mitigado.com', '2023-03-28', b'1', 4, 4, 5, 0),
(7, 'Eduardo', 'Rios Fonseca', 87239930, '2006-06-03', 'Masculino', 'http://www.example.org/battle.aspx', 'hayoicrettufrei-2477@yopmail.com', '2023-03-01', b'1', 5, 4, 5, 0),
(8, 'Marianela', 'Vazquez', 49371093, '2007-05-02', 'Femenino', 'https://www.example.com/bee/animal.php', 'griddeppabreppou-6788@yopmail.com', '2023-03-02', b'1', 6, 4, 5, 0),
(9, 'Ricardo Alejandro', 'Medina Contreras', 83420458, '2006-11-25', 'Masculino', 'http://boat.example.com/battle/box.php#addition', 'tojummefaha-1575@yopmail.com', '2023-02-28', b'1', 7, 4, 5, 0),
(10, 'Milagro', 'Padron', 26970594, '2007-08-26', 'Femenino', 'https://www.example.com/balance.html?border=attack&argument=apparel', 'fritanneupauge-3446@yopmail.com', '2023-03-01', b'1', 8, 4, 5, 0),
(11, 'Veronica Amanda', 'Castro', 47256631, '2005-03-23', 'Femenino', 'http://birth.example.net/afterthought.html?agreement=apparel&bird=bear', 'wajaullocroce-2303@yopmail.com', '2023-03-03', b'1', 9, 5, 5, 0),
...
(26, 'Sonia Alejandra', 'Sanchez Matinez', 1983048493, '2023-04-09', 'f', 'http://localhost/phpmyadmin/index.php?route=/table/change&db=segunda&table=registro', 'soniamarti@gmail.com', '2023-04-09', b'1', 1, 3, 4, 1);
...
INSERT INTO `rol` (`id_rol`, `tipo_rol`, `id_resgistro`) VALUES
(1, 'Administrador', 0),
(2, 'Estudiante', 0);
...
ALTER TABLE `rol`
  ...
  ADD KEY `id_resgistro` (`id_resgistro`);
