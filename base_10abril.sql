...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 11-04-2023 a las 01:38:28
...
(12, 'Nicolas', 'Guzman', 58836957, '2005-04-16', 'Masculino', 'http://www.example.edu/afterthought/base.php?book=book#aftermath', 'tricubrezaje-6955@yopmail.com', '2023-03-02', b'1', 10, 5, 5, 2),
(13, 'Alicia Pamela', 'Reyes ', 48477688, '2006-02-27', 'Femenino', 'https://example.net/approval/attraction.html', 'brajocrebeuzo-1996@yopmail.com', '2023-02-28', b'1', 11, 5, 5, 2),
(14, 'Pedro Jose', 'Alvarado Jimenez', 93716496, '2006-03-11', 'Masculino', 'https://sample.net/#hose', 'tegossekeli-1611@yopmail.com', '2023-02-28', b'1', 12, 5, 5, 2),
(15, 'Octavio', 'Hernandez', 74515958, '2006-10-18', 'Masculino', 'http://sample.info/?insect=fireman&porter=attraction#cave', 'habogazeippa-7785@yopmail.com', '2023-03-04', b'1', 13, 5, 5, 2),
(16, 'Martina Alba', 'Giron', 63376322, '2007-12-31', 'Femenino', 'http://www.sample.edu/?stone=government&judge=muscle#zebra', 'martina74@hotmail.com', '2023-03-09', b'1', 14, 4, 3, 2),
(17, 'Dario', 'Delgado', 97786821, '2007-12-25', 'Masculino', 'https://www.sample.org/?friends=volcano&control=rest#shoes', 'dario_delg@gmail.com', '2023-03-05', b'1', 15, 4, 3, 2),
(18, 'Francisco Alonso', 'Menjivar Lopez', 69459495, '2005-06-19', 'Masculino', 'https://www.sample.net/?screw=cap&teeth=tongue', 'frank_mnj70@gmail.com', '2023-03-19', b'1', 16, 5, 3, 2),
(19, 'Estefani', 'Ramos', 50658741, '2005-11-23', 'Femenino', 'https://sample.org/?scarecrow=face&coat=blow', 'estef88@gmail.com', '2023-03-19', b'1', 17, 5, 3, 2),
(20, 'Miguel Angel', 'Obrador Gonzalez', 48432436, '2006-10-04', 'Masculino', 'https://www.paper.sample.edu/move/wax?science=chickens#cherries', 'miguelito.gonza@yahoo.com', '2023-03-01', b'1', 18, 5, 3, 2),
(21, 'Andres Alejandro', 'Narvaez', 81563040, '2006-08-10', 'Masculino', 'http://sample.com/zipper#glove', 'nar_vaez586@gmail.com', '2023-03-24', b'1', 19, 4, 1, 2),
(22, 'Samuel Enrique', 'Bravo Soto', 49478480, '2007-07-18', 'Masculino', 'http://www.sample.info/grandmother.php', 'samu_bravo54@gmail.com', '2023-03-06', b'1', 20, 4, 1, 2),
(23, 'Sonia Mercedes', 'Lara Torres', 20605739, '2006-07-20', 'Femenino', 'http://knot.sample.info/wax/agreement.html', 'sonnie.torres24@hotmail.com', '2023-03-01', b'1', 21, 4, 1, 2),
(24, 'Genesis Virginia', 'Puente Dominguez', 25518894, '2006-05-08', 'Femenino', 'http://www.sample.com/?direction=month&knot=zoo', 'virginia.puente45@yahoo.com', '2023-03-15', b'1', 22, 5, 1, 2),
(25, 'Julio Cesar', 'Navarro', 52395576, '2005-09-09', 'Masculino', 'https://www.sample.org/cellar', 'juliocesar_navarro@yahoo.com', '2023-03-30', b'1', 23, 5, 1, 2),
...
ALTER TABLE `registro`
  ...
  ADD CONSTRAINT `registro_ibfk_5` FOREIGN KEY (`id_rol`) REFERENCES `rol` (`id_rol`);
